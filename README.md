...
[Here](Archtecture_Options_for_Fusion_Data_Extraction.pptx) is a presentation put together by Martha Aguilar that summarizes the options.  Note that this document is not fully integrated with the presentation and there may be some inconsistencies in the options noted below and the presentation.
